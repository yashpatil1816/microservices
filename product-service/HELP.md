...
* The original package name 'com.cfs.product-service' is invalid and this project uses 'com.cfs.product_service' instead.
...
* [Getting Started with Distributed Tracing](https://docs.spring.io/spring-boot/3.5.10/reference/actuator/tracing.html)
